...
trovato l'ultimo commit della release faccio il checkout per calcolarmi le caratteristiche. in particolare per ultimo commit si intende quello prima della release, quindi l'ultimo della release precedente in corso.

ad esempio
se la data della release viene da jira ed è il 18 maggio ma ho un commit il 17 maggio ed uno il 20 considero come ultimo commit quello del 17 maggio. 
altro esempio:
se ho la release 2.2.1 il 13 febbraio vado a considerare come ultimo commit quello della release 2.2.0!

su quel checkout voglio predirre la bugginess.
